...
void CMyApp::Render()
{
	...
	glUniform1f(glGetUniformLocation(m_programID, "px"), mouseX / 10.0);
	glUniform1f(glGetUniformLocation(m_programID, "py"), mouseY / 10.0);
...
void CMyApp::MouseMove(SDL_MouseMotionEvent& mouse)
{
	...
	mouseX = mouse.x - w / 2.0;
	mouseY = -(mouse.y - h / 2.0);
}
