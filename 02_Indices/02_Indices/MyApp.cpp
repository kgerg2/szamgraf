...
bool CMyApp::Init()
{
	...
	{ 
		...
		{glm::vec3( 1,  1, 0), glm::vec3(1, 1, 0.2)},
...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3( 5*cos(SDL_GetTicks() / 1000.0),  0,  5*sin(SDL_GetTicks() / 1000.0)),		// honnan nézzük a színteret
...
void CMyApp::Render()
{
	...
	*/
	...
	glDrawElements(	GL_TRIANGLES,		// primitív típus
					30,					// hany csucspontot hasznalunk a kirajzolashoz
					GL_UNSIGNED_SHORT,	// indexek tipusa
					0);					// indexek cime


	m_matWorld = glm::rotate<float>(M_PI, glm::vec3(1, 1, 0));
	//m_matWorld = glm::scale<float>(glm::vec3(0, -1, 0));
