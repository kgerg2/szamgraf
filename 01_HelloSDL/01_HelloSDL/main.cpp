...
int main( int argc, char* args[] )
{
	...
	SDL_RenderDrawLine(ren, 55, 10, 55, 60);
	SDL_RenderDrawLine(ren, 55, 10, 85, 10);
	SDL_RenderDrawLine(ren, 55, 35, 85, 35);
	SDL_RenderDrawLine(ren, 55, 60, 85, 60);

	SDL_RenderDrawLine(ren, 100, 10, 100, 60);
	SDL_RenderDrawLine(ren, 100, 60, 130, 60);

	SDL_RenderDrawLine(ren, 145, 10, 145, 60);
	SDL_RenderDrawLine(ren, 145, 60, 175, 60);

	SDL_RenderDrawLine(ren, 190, 10, 190, 60);
	SDL_RenderDrawLine(ren, 190, 60, 220, 60);
	SDL_RenderDrawLine(ren, 190, 10, 220, 10);
	SDL_RenderDrawLine(ren, 220, 10, 220, 60);
	...
	for (int i = 0; i < 3; i++) {
		...
		SDL_SetRenderDrawColor(ren,	// melyik renderelõnek állítjuk be az aktuális rajzolási színét
			i == 0 ? 255 : 0,	// vörös intenzitás - 8 bites elõjel nélküli egész szám
			i == 1 ? 255 : 0,		// zöld intenzitás - 8 bites elõjel nélküli egész szám
			i == 2 ? 255 : 0,		// kék intenzitás - 8 bites elõjel nélküli egész szám
			255);	// átlátszóság - 8 bites elõjel nélküli egész szám
		SDL_RenderClear(ren);
